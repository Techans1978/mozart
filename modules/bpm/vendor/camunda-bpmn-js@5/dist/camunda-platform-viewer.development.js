(function (global, factory) {
  ...
  var bind$1$1, unbind$1$1, prefix$8;
  ...
  var bind_1$1 = componentEvent$1.bind = function(el, type, fn, capture){
  ...
  var unbind_1$1 = componentEvent$1.unbind = function(el, type, fn, capture){
    if (!unbind$1$1) detect$1();
    el[unbind$1$1](prefix$8 + type, fn, capture || false);
    return fn;
  };
  ...
  function BpmnRenderer(
    ...
    function addMarker(id, options) {
      ...
      var defs = query$1(':scope > defs', parentGfx);
  ...
  *
  ...
  function DrilldownBreadcrumbs(eventBus, elementRegistry, canvas) {
    var breadcrumbs = domify$1$1('<ul class="bjs-breadcrumbs"></ul>');
    ...
    function updateBreadcrumbs(element) {
      ...
      var path = businessObjectParents.flatMap(function(parent) {
        ...
        var link = domify$1$1('<li><span class="bjs-crumb"><a title="' + title + '">' + title + '</a></span></li>');
  ...
  DrilldownOverlayBehavior.prototype._addOverlay = function(element) {
    ...
    var button = domify$1$1('<button type="button" class="bjs-drilldown">' + ARROW_DOWN_SVG + '</button>'),
  ...
  */
  ...
  BaseViewer.prototype.saveSVG = async function saveSVG() {
    ...
    try {
      ...
      const contentNode = canvas.getActiveLayer(),
            defsNode = query$1(':scope > defs', canvas._svg);
  ...
  function addProjectLogo(container) {
    ...
    event$1.bind(linkElement, 'click', function(event) {
      open();
