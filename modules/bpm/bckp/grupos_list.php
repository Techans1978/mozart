...
// 1) Traz todos os categorias (id, nome, parent_id, ativo, codigo) — simples e confiável
$sql = "SELECT id, nome, parent_id, ativo, codigo FROM bpm_categorias ORDER BY nome ASC";
$res = $conn->query($sql);
